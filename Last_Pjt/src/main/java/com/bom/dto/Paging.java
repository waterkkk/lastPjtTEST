...
public class Paging {
    ...
    private void makePaging() {
        ...
        System.out.println(firstPageNo); // 첫 번째 페이지 번호
        System.out.println(prevPageNo); 
        System.out.println(startPageNo); // 시작 페이지 (페이징 네비 기준)
        System.out.println(pageNo);  // 페이지 번호
        System.out.println(endPageNo); // 끝 페이지 (페이징 네비 기준)
        System.out.println(nextPageNo);  // 다음 페이지 번호
        System.out.println(finalPageNo);  // 마지막 페이지 번호
