               ...
               $.each(data, function(key,val) {
                  if (key=="DESCRIPTION") {
                     ...
                     $("thead").html(
                        ...
                        "<th width=" +"80px;>지역</th>"+
                        "<th width=" +"80px;>"+val.USE_TRGT+"</th>"+
                        "<th width=" +"80px;>"+val.USE_FEE+"</th>"+
    ...
    <div class="abc">
      <div class="row">
        <div class="col-md-12"><br/><br/><br/><br/><br/>
          <h1 style="color: #bfa100; text-align: center;">문화행사</h1><br/>
          <h4></h4>
        </div>
      </div>
    </div>
  ...
  <c:if test="${empty dto.member_id }">
   ...
   <div class="container">
      ...
      <div class="container" style="display: flex;">
         <select class="form-control" id="searchAPI" style="width: 150px; text-align: center; height: 50px; font-size: 20px;">
