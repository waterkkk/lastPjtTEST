     	 ...
     	 <div class="row">
        	<div class="col-md-12" >
   	    	...
   	    	<div class="col-md-12" align="right" >
				<a href="eduoffList.do" class="btn btn-outline-primary btn-lg">오프라인 강의 찾아보기</a>
				<a  class="btn btn-primary btn-lg">지도에서 교육기관 찾아보기</a>
			</div>		
    	</div>
	 </div>
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="중구 어르신" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=096ffb811f0bb77a560da00543fc262f&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
